  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t('breadcrumb.faqs.edit'),
          disabled: true,
          href: '',
        },
      ],
  ...
  methods: {
    ...
    getData() {
      this.$axios({
        ...
        this.data.ar.question = res.data.data.ar.name
        this.data.en.question = res.data.data.en.name
        this.data.ar.answer = res.data.data.ar.desc
        this.data.en.answer = res.data.data.en.desc
      })
    },
  },
